...
public interface ISimpleLanguageVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitFunDecl([NotNull] SimpleLanguageParser.FunDeclContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="SimpleLanguageParser.function"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitFunction([NotNull] SimpleLanguageParser.FunctionContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="SimpleLanguageParser.parameters"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitParameters([NotNull] SimpleLanguageParser.ParametersContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitArguments([NotNull] SimpleLanguageParser.ArgumentsContext context);
	/// <summary>
