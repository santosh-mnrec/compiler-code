...
public interface ISimpleLanguageListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterFunDecl([NotNull] SimpleLanguageParser.FunDeclContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="SimpleLanguageParser.funDecl"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitFunDecl([NotNull] SimpleLanguageParser.FunDeclContext context);
	/// <summary>
	/// Enter a parse tree produced by <see cref="SimpleLanguageParser.function"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterFunction([NotNull] SimpleLanguageParser.FunctionContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="SimpleLanguageParser.function"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitFunction([NotNull] SimpleLanguageParser.FunctionContext context);
	/// <summary>
	/// Enter a parse tree produced by <see cref="SimpleLanguageParser.parameters"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterParameters([NotNull] SimpleLanguageParser.ParametersContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="SimpleLanguageParser.parameters"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitParameters([NotNull] SimpleLanguageParser.ParametersContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterArguments([NotNull] SimpleLanguageParser.ArgumentsContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="SimpleLanguageParser.arguments"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitArguments([NotNull] SimpleLanguageParser.ArgumentsContext context);
	/// <summary>
